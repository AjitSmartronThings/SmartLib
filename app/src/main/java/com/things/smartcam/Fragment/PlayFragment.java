...
import com.things.smartcam.util.AngleView;
...
//        fixPlayerRatio(renderView, maxWidth, maxHeight, mWidth, mHeight);
    ...
    protected void startRending(SurfaceTexture surface) {
        sMoviePath = getContext().getExternalFilesDir(Environment.DIRECTORY_MOVIES) + "/EasyPlayer";
